...
\title{\textcolor{blue}{Progressão Aritmética: Função Afim de Domínio Discreto}}
...
Relacionar Progressões Aritméticas com funções afins de domínio discreto:
\begin{quote}
\small
    (EM13MAT507PE46) Identificar e associar progressões aritméticas (PA) a funções afins de domínios discretos, para análise de propriedades, dedução de fórmulas e resolução de problemas.
\end{quote}
...
\item (ENEM) Um teatro tem 18 filas de cadeiras. Na 1ª fila há 20 cadeiras, na 2ª 23, na 3ª 26, e assim por diante. Quantas cadeiras tem o teatro?
...
\node[blue] at (2.5,2.5) {$f(x)=0.5x+1$};
...
\item Prove que em qualquer PA finita, a média dos extremos é igual à média aritmética dos termos equidistantes dos extremos, usando propriedades de funções afins.
\end{enumerate}
