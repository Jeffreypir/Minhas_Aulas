...
\section*{Revisão de Aprofundamento em Matemática \\ Análise Combinatória}
...
\textbf{Interpretação final:} Existem 10 pedidos diferentes possíveis (cada tipo de café combinado com cada tipo de adoçante).\\
...
\textbf{Interpretação final:} Há 10\,000 senhas possíveis de 4 dígitos com repetição permitida.\\
...
\textbf{Interpretação final:} Existem 12 números de dois algarismos distintos formados com os algarismos dados.\\
...
\textbf{Interpretação final:} Há 120 formas diferentes de organizar os 5 livros.\\
...
\textbf{Passo 2: Aplicar combinação de 2 entre 6.}\\
\[
\binom{6}{2} = \frac{6 \times 5}{2} = 15.
\]

\textbf{Interpretação final:} Há 15 possíveis duplas diferentes.\\
...
\textbf{Interpretação final:} A pessoa pode montar 12 combinações diferentes de roupa.\\
...
\textbf{Interpretação final:} São 6 anagramas possíveis.\\
...
\textbf{Interpretação final:} Existem 20 formas distintas de atribuir os dois cargos.\\
...
\textbf{Interpretação final:} São 24 combos diferentes possíveis.\\
