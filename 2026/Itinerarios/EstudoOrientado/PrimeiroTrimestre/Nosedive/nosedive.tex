...
\subsection*{Questões de Objetivas}

\hspace{0.6cm}1. Qual é a profissão inicial de Lacie Pound?  

2. Qual sistema de avaliação social mostrado no episódio é utilizado?  
...
\hspace{0.6cm}11. Explique como o sistema de avaliação afeta o comportamento das pessoas no episódio.  
...
\hspace{0.6cm}16. Se você vivesse nessa sociedade, que estratégia usaria para manter uma alta avaliação sem perder sua autenticidade?  
